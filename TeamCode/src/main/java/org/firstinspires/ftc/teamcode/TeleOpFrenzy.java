...
//        driver.getGamepadButton(GamepadKeys.Button.DPAD_UP).whenPressed(liftCommand);
        ...
        driver.getGamepadButton(GamepadKeys.Button.RIGHT_BUMPER).whenHeld(new StartEndCommand(() -> intakeMotor.set(0.8), () -> intakeMotor.stopMotor()));
        driver.getGamepadButton(GamepadKeys.Button.LEFT_BUMPER).whenHeld(new StartEndCommand(() -> intakeMotor.set(-0.8), () -> intakeMotor.stopMotor()));
